...
// superior a 70 y se ubicaron en una longitud inferior a -65.754168.
...
// calificación 'A' que no pertenece al distrito de Brooklyn.
...
// 10- Devolver ID del restaurante, nombre, distrito y la cocina de aquellos restaurantes
// que lograron una puntuación que no supere los 10
db.restaurantes.find(
  { "grades.score": { $lte: 10 } },
  { restaurant_id: 1, name: 1, borough: 1, cuisine: 1, _id: 0 }
)

// 11- Devolver ID del restaurante, el nombre y las calificaciones del restaurante para
// aquellos restaurantes que obtuvieron una calificación de "A" y obtuvieron un puntaje
// de 11 en una fecha ISO "2014-08-11T00:00:00Z" entre muchas fechas de encuesta
db.restaurantes.find(
  { grades: { $elemMatch: { grade: "A", score: 11, date: ISODate("2014-08-11T00:00:00Z") } } },
  { restaurant_id: 1, name: 1, grades: 1, _id: 0 }
)

// 12- Devolver ID del restaurante, nombre, dirección y ubicación geográfica del restaurante
// de aquellos donde el segundo elemento de la matriz coord contiene un valor que es más
// de 42 y hasta 52
db.restaurantes.find(
...
// 13- Crea un par de restaurantes que te gusten.
// Tendrás que buscar en Google Maps los datos de las coordenadas
